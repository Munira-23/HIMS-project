...
<div class="col-sm-5 col">
	<a href="#add_permission" data-toggle="modal" class="btn btn-success float-right mt-2"style="background-color:#6082B6">Add Permission</a>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="{{route('permissions.store')}}">
					...
					<button type="submit" class="btn btn-success btn-block"style=background-color:#6082B6>Save Changes</button>
				</form>
			</div>
		</div>
	</div>
