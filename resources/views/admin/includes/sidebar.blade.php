			...
			<ul>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						@can('view-outstock-products')<li><a class="{{ route_is('products.outstock') ? 'active' : '' }}" href="{{route('products.outstock')}}">Out-Stock</a></li>@endcan
				...
				@can('view-purchase')
				<li class="submenu">
					<a href="#"><i class="fe fe-star-o"></i> <span> Inventory Restocking</span> <span class="fas fa-chevron-down"></span></a>
					<ul style="display: none;">
						<li><a class="{{ route_is('purchases.*') ? 'active' : '' }}" href="{{route('purchases.index')}}">Restocking</a></li>
						@can('create-purchase')
						<li><a class="{{ route_is('purchases.create') ? 'active' : '' }}" href="{{route('purchases.create')}}">Add New</a></li>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li><a class="{{ route_is('purchases.reports') ? 'active' : '' }}" href="{{route('purchases.reports')}}">Restocking Report</a></li>
						<li><a href="{{ route('stockusage.report') }}">Stock Usage Reports</a></li>
						<li><a href="{{ route('expired.report') }}">Expired Stock Reports</a></li>
